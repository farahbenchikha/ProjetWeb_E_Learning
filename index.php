            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                <div class="container px-5">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                       ...
                       <li class="nav-item"><a class="nav-link" href="addT.php">Contact</a></li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownBlog">
                                    <li><a class="dropdown-item" href="ajouterresumes.php">etudiant</a></li>
                                    <li><a class="dropdown-item" href="ajouterresumes.php">enseingant</a></li>
                                </ul>
                            </li>

                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" id="navbarDropdownPortfolio" href="" role="button" data-bs-toggle="dropdown" aria-expanded="false">Examens</a>
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownPortfolio">
                                    
                                    <li><a class="dropdown-item" href="afficherexamen.php">La liste des Examens</a></li>
                                </ul>
                            </li>
                            <!--quiz-->
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" id="navbarDropdownBlog" href="afficherListeQuiz.php" role="button" data-bs-toggle="dropdown" aria-expanded="false">Quiz</a>
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownBlog">
                                    <li><a class="dropdown-item" href="afficherListeQuiz.php">Liste </a></li>
                                    <li><a class="dropdown-item" href="ajouterQuiz.php">Ajout</a></li>
                                </ul>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" id="navbarDropdownBlog" href="afficherListeQuiz.php" role="button" data-bs-toggle="dropdown" aria-expanded="false">Question</a>
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownBlog">
                                    <li><a class="dropdown-item" href="afficherListeQuestion.php">Liste </a></li>
                                    <li><a class="dropdown-item" href="ajouterQuestion.php">Ajout</a></li>
                                </ul>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" id="navbarDropdownBlog" href="afficherListeQuiz.php" role="button" data-bs-toggle="dropdown" aria-expanded="false">Option</a>
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownBlog">
                                    <li><a class="dropdown-item" href="afficherListeQuestion_opt.php">Liste </a></li>
                                    <li><a class="dropdown-item" href="ajouterQuestion_opt.php">Ajout</a></li>
                                </ul>
                            </li>
                    ...
                    <div class="row gx-5">
                        <div class="col-xl-8">
                            ...
                            <div class="text-end mb-5 mb-xl-0">
                                <a class="text-decoration-none" href="ajoutercours.php">
                                    Ajouter cours
                                    ...
                                    <div class="d-flex h-100 align-items-center justify-content-center">
                                        <div class="text-center">
                                            ...
                                            <p class="text-muted mb-4">
                                                ...
                                                <br />
                                                <a href="addT.php">press@domain.com</a>
                                            </p>
                    ...
                    <div class="row gx-5">
                                ...
                                <div class="row gx-5">
                                    <div class="col-lg-4 mb-5">
                                        <div class="card h-100 shadow border-0">
                                            ...
                                            <div class="card-body p-4">
                                                <div class="badge bg-primary bg-gradient rounded-pill mb-2">New</div>
                                                <a class="text-decoration-none link-dark stretched-link" href="paiement.php"><div class="h5 card-title mb-3">Les Certificats pour les Niveaux A</div></a>
                                            ...
                                            <div class="card-footer p-4 pt-0 bg-transparent border-top-0">
                                                ...
                                                <td>
                                                    <form method="POST" action="paiement.php">
                                                        ...
                                                        <input type="hidden" value="paiement">
                                                    </form>
                                                    </td>
                                                    </div>
                                                </div>
                        ...
                        <div class="col-lg-4 mb-5">
                            <div class="card h-100 shadow border-0">
                                ...
                                <div class="card-body p-4">
                                    <div class="badge bg-primary bg-gradient rounded-pill mb-2">New</div>
                                    <a class="text-decoration-none link-dark stretched-link" href="paiement.php"><div class="h5 card-title mb-3">Les Certificats pour les Niveaux B </div></a>
                        ...
                        <div class="col-lg-4 mb-5">
                            <div class="card h-100 shadow border-0">
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <a class="text-decoration-none link-dark stretched-link" href="paiement.php"><div class="h5 card-title mb-3">Les Certificats pour les Niveaux C</div></a>
